...
function Home() {
  return (
    <section className='gird w-full h-auto flex flex-wrap m-7 p-1 '>
      ...
      <div className='grid mt-5 place-items-center  grid-cols-1 gap-4 sm:grid-cols-1 md:grid-cols-4 lg:grid-cols-5 w-full'>
      {
        data.map((result)=>{
